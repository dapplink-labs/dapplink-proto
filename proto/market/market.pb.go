...
var file_dapplink_market_proto_rawDesc = []byte{
...
var (
	...
	file_dapplink_market_proto_rawDescData = file_dapplink_market_proto_rawDesc
)

func file_dapplink_market_proto_rawDescGZIP() []byte {
	file_dapplink_market_proto_rawDescOnce.Do(func() {
		file_dapplink_market_proto_rawDescData = protoimpl.X.CompressGZIP(file_dapplink_market_proto_rawDescData)
	})
	return file_dapplink_market_proto_rawDescData
}

var file_dapplink_market_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_dapplink_market_proto_goTypes = []interface{}{
...
func file_dapplink_market_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_dapplink_market_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dapplink_market_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Asset); i {
			case 0:
				return &v.state
			case 1:
		...
		file_dapplink_market_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Symbol); i {
			case 0:
				return &v.state
			case 1:
		...
		file_dapplink_market_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dapplink_market_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dapplink_market_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dapplink_market_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dapplink_market_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dapplink_market_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dapplink_market_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dapplink_market_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dapplink_market_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dapplink_market_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dapplink_market_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dapplink_market_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dapplink_market_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dapplink_market_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dapplink_market_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_dapplink_market_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   18,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_dapplink_market_proto_rawDesc = nil
