...
var file_dapplink_l3staking_proto_goTypes = []interface{}{
...
func file_dapplink_l3staking_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_dapplink_l3staking_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dapplink_l3staking_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
