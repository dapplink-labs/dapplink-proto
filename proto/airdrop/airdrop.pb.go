...
var file_dapplink_airdrop_proto_rawDesc = []byte{
...
var (
	...
	file_dapplink_airdrop_proto_rawDescData = file_dapplink_airdrop_proto_rawDesc
)

func file_dapplink_airdrop_proto_rawDescGZIP() []byte {
	file_dapplink_airdrop_proto_rawDescOnce.Do(func() {
		file_dapplink_airdrop_proto_rawDescData = protoimpl.X.CompressGZIP(file_dapplink_airdrop_proto_rawDescData)
	})
	return file_dapplink_airdrop_proto_rawDescData
}

var file_dapplink_airdrop_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_dapplink_airdrop_proto_goTypes = []interface{}{
...
func file_dapplink_airdrop_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_dapplink_airdrop_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dapplink_airdrop_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_dapplink_airdrop_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_dapplink_airdrop_proto_rawDesc = nil
