...
var file_savour_rpc_airdrop_proto_goTypes = []any{
...
func file_savour_rpc_airdrop_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_savour_rpc_airdrop_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_savour_rpc_airdrop_proto_msgTypes[1].Exporter = func(v any, i int) any {
